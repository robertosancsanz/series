...
class SeriesListViewModelFactory(
    ...
    override fun <T : ViewModel?> create(modelClass: Class<T>): T = SeriesListViewModel(useCase,
                                                                                        useCaseDownload, useCasePauseDownload, useCaseResumeDownload, useCaseCancelDownload) as? T
