...
"https://www.ecestaticos.com/imagestatic/clipping/03b/c8f/03bc8fb84150aa179e63bc8898802516/imagen-sin-titulo.jpg?mtime=1531473691",
...
"para limpiar la ciudad y acabar con la banda.",
...
"http://mirrors.standaloneinstaller.com/video-sample/Panasonic_HDC_TM_700_P_50i.mp4"
    ...
    override fun fetchSeriesById(id: Int): Serie? = series.firstOrNull { it.id == id }
