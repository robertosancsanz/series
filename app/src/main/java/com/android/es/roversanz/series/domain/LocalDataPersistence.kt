...
class LocalDataPersistence : DataPersistence {
    ...
    private val series: MutableList<Serie> by lazy {
        mutableListOf(
                Serie(1, "El Cuento de la Criada", "Muy heavy", "https://www.ecestaticos.com/imagestatic/clipping/03b/c8f" +
                        "/03bc8fb84150aa179e63bc8898802516/imagen-sin-titulo.jpg?mtime=1531473691"),
